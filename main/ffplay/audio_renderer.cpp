 ...
 * value.
 */
int AudioRenderer::audio_decode_frame(VideoState *is) {
...
int AudioRenderer::audio_open(void *opaque, int64_t wanted_channel_layout, int wanted_nb_channels, 
	int wanted_sample_rate, struct AudioParams *audio_hw_params) {
	return SdlRenderer::audio_open(opaque, wanted_channel_layout, wanted_nb_channels, 
...
void AudioRenderer::audio_thread(void *arg) {
