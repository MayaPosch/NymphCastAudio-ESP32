...
display:
    ...
    if (show_status) {
        ...
        if (!last_time || (cur_time - last_time) >= 30000) {
			...
			StreamHandler::setPosition(master_clock);
...
void VideoRenderer::video_thread(void *arg) {
...
void VideoRenderer::update_sample_display(VideoState *is, short *samples, int samples_size)
{
    int size, len;
