...
bool DateTimeParser::parse(const std::string& fmt, const std::string& str, DateTime& dateTime, int& timeZoneDifferential)
{
...
bool DateTimeParser::tryParse(const std::string& fmt, const std::string& str, DateTime& dateTime, int& timeZoneDifferential)
{
	//try
	//{
		return parse(fmt, str, dateTime, timeZoneDifferential);
	/* }
	catch (Exception&)
	{
		return false;
...
bool DateTimeParser::parse(const std::string& str, DateTime& dateTime, int& timeZoneDifferential) {
