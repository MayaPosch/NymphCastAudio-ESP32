/*
	SignalHandler.h - Definition of the SignalHandler class.
*/


#ifndef Core_SignalHandler_INCLUDED
#define Core_SignalHandler_INCLUDED
...
#endif // Core_SignalHandler_INCLUDED
