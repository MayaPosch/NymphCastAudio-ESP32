/*
	NumberParser.h - Definition of the NumberParser class.
*/


#ifndef Core_NumberParser_INCLUDED
#define Core_NumberParser_INCLUDED
...
///
/// Note that leading or trailing whitespace is not allowed in the string. Poco::trim() 
/// or Poco::trimInPlace() can be used to remove leading or trailing whitespace.
...
#endif // Core_NumberParser_INCLUDED
