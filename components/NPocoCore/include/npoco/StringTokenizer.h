/*
	StringTokenizer.h - Definition of the StringTokenizer class.
*/


#ifndef Core_StringTokenizer_INCLUDED
#define Core_StringTokenizer_INCLUDED
...
{
	if (index >= _tokens.size()) { return _tokens[0]; } //throw RangeException();
...
#endif // Core_StringTokenizer_INCLUDED
