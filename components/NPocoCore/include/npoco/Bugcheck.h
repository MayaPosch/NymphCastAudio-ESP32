/*
	Bugcheck.h - Definition of the Bugcheck class and the self-testing macros.
*/


#ifndef Core_Bugcheck_INCLUDED
#define Core_Bugcheck_INCLUDED
...
/// This class provides some static methods that are used by the
/// poco_assert_dbg(), poco_assert(), poco_check_ptr(), 
/// poco_bugcheck() and poco_unexpected() macros. 
/// You should not invoke these methods directly. Use the macros instead, as they
