/*
	Condition.h - Definition of the Condition class template.
*/


#ifndef Core_Condition_INCLUDED
#define Core_Condition_INCLUDED
...
public:
	...
	template <class Mtx>
	bool wait(Mtx& mutex, long milliseconds) {
		if (!tryWait(mutex, milliseconds)) { return false; }
