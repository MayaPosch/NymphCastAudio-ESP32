/*
	DateTimeParser.h - Definition of the DateTimeParser class.
*/


#ifndef Core_DateTimeParser_INCLUDED
#define Core_DateTimeParser_INCLUDED
...
#endif // Core_DateTimeParser_INCLUDED
