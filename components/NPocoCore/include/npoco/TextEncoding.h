/*
	TextEncoding.h - Definition of the abstract TextEncoding class.
*/


#ifndef Core_TextEncoding_INCLUDED
#define Core_TextEncoding_INCLUDED
...
#endif // Core_TextEncoding_INCLUDED
