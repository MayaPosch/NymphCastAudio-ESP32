/*
	UnufferedStreamBuf.h - Definition of template BasicUnbufferedStreamBuf and class UnbufferedStreamBuf.
*/


#ifndef Core_UnbufferedStreamBuf_INCLUDED
#define Core_UnbufferedStreamBuf_INCLUDED
...
#endif // Core_UnbufferedStreamBuf_INCLUDED
