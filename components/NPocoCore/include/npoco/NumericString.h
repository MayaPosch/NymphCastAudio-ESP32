/*
	NumericString.h - Numeric string utility functions.
*/


#ifndef Core_NumericString_INCLUDED
#define Core_NumericString_INCLUDED
...
#endif // Core_NumericString_INCLUDED
