/*
	DateTimeFormat.h - Definition of the DateTimeFormat class.
*/


#ifndef Core_DateTimeFormat_INCLUDED
#define Core_DateTimeFormat_INCLUDED
...
#endif // Core_DateTimeFormat_INCLUDED
