/*
	NotificationStrategy.h - Definition of the NotificationStrategy interface.
*/


#ifndef Core_NotificationStrategy_INCLUDED
#define Core_NotificationStrategy_INCLUDED
...
#endif // Core_NotificationStrategy_INCLUDED
