/*
	LocalDateTime.h - Definition of the LocalDateTime class.
*/


#ifndef Core_LocalDateTime_INCLUDED
#define Core_LocalDateTime_INCLUDED
...
protected:
	...
	bool determineTzd(bool adjust = false);
...
#endif // Core_LocalDateTime_INCLUDED
