/*
	AbstractEvent.h - Definition of the AbstractEvent class.
*/


#ifndef Core_AbstractFoundation_INCLUDED
#define Core_AbstractFoundation_INCLUDED
...
#endif // Core_AbstractFoundation_INCLUDED
