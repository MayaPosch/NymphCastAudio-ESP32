/*
	MetaProgramming.h - Common definitions useful for Meta Template Programming
*/


#ifndef Core_MetaProgramming_INCLUDED
#define Core_MetaProgramming_INCLUDED
...
#endif // Core_MetaProgramming_INCLUDED
