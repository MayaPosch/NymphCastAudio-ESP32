/*
	NumberFormatter.h - Definition of the NumberFormatter class.
*/


#ifndef Core_NumberFormatter_INCLUDED
#define Core_NumberFormatter_INCLUDED
...
#endif // Core_NumberFormatter_INCLUDED