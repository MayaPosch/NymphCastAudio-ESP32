/*
	DateTimeFormatter.h - Definition of the DateTimeFormatter class.
*/


#ifndef Core_DateTimeFormatter_INCLUDED
#define Core_DateTimeFormatter_INCLUDED
...
#endif // Core_DateTimeFormatter_INCLUDED
