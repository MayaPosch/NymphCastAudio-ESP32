/*
	UnicodeConverter.h - Definition of the UnicodeConverter class.
*/


#ifndef Core_UnicodeConverter_INCLUDED
#define Core_UnicodeConverter_INCLUDED
...
#endif // Core_UnicodeConverter_INCLUDED
