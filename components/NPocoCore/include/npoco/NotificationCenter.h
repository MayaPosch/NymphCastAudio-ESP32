/*
	NotificationCenter.h - Definition of the NotificationCenter class.
*/


#ifndef Core_NotificationCenter_INCLUDED
#define Core_NotificationCenter_INCLUDED
...
#endif // Core_NotificationCenter_INCLUDED
