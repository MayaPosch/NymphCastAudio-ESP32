/*
	MemoryStream.h - Definition of MemoryStreamBuf, MemoryInputStream, MemoryOutputStream
*/


#ifndef Core_MemoryStream_INCLUDED
#define Core_MemoryStream_INCLUDED
...
#endif // Core_MemoryStream_INCLUDED
