/*
	FPEnvironment_DUMMY.h - Definition of class FPEnvironmentImpl for platforms that do not
								support IEEE 754 extensions.
*/


#ifndef Core_FPEnvironment_DUMMY_INCLUDED
#define Core_FPEnvironment_DUMMY_INCLUDED
...
#endif // Core_FPEnvironment_DUMMY_INCLUDED
