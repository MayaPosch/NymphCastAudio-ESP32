/*
	FPEnvironment_DEC.h - Definitions of class FPEnvironmentImpl for Tru64 and OpenVMS Alpha.
*/


#ifndef Core_FPEnvironment_DEC_INCLUDED
#define Core_FPEnvironment_DEC_INCLUDED
...
#endif // Core_FPEnvironment_DEC_INCLUDED
