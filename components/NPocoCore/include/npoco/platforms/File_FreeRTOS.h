/*
	File_FreeRTOS.h - Definition of the FileImpl class for Unix.
*/


#ifndef Core_File_FreeRTOS_INCLUDED
#define Core_File_FreeRTOS_INCLUDED
...
#endif // Core_File_FreeRTOS_INCLUDED
