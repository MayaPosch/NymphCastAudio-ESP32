/*
	FPEnvironment_QNX.h - Definitions of class FPEnvironmentImpl for QNX.
*/


#ifndef Core_FPEnvironment_QNX_INCLUDED
#define Core_FPEnvironment_QNX_INCLUDED
...
#endif // Core_FPEnvironment_QNX_INCLUDED
