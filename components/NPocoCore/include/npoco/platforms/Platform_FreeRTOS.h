/*
	Platform_FreeRTOS.h - Platform and architecture identification macros and definitions for 
							various POSIX platforms.
*/


#ifndef Core_Platform_FreeRTOS_INCLUDED
#define Core_Platform_FreeRTOS_INCLUDED
...
#endif // Core_Platform_FreeRTOS_INCLUDED
