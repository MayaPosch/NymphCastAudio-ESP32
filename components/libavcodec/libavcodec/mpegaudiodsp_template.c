...
*/
DECLARE_ALIGNED(16, INTFLOAT, RENAME(ff_mdct_win))[8][MDCT_BUF_SIZE] EXT_RAM_BSS_ATTR;

DECLARE_ALIGNED(16, MPA_INT, RENAME(ff_mpa_synth_window))[512+256] EXT_RAM_BSS_ATTR;
