...
static DECLARE_ALIGNED(32, float, mdct_window)[MDCT_SIZE] EXT_RAM_BSS_ATTR;
static VLCElem atrac3_vlc_table[7 * 1 << ATRAC3_VLC_BITS] EXT_RAM_BSS_ATTR;
static VLC   spectral_coeff_tab[7] EXT_RAM_BSS_ATTR;
